...
public class O2LazerRulesetConfigManager : RulesetConfigManager<O2LazerRulesetSetting>
{
    public O2LazerRulesetConfigManager(SettingsStore? settings, RulesetInfo ruleset, int? variant = null)
    ...
    protected override void InitialiseDefaults()
    {
        ...
        SetDefault(O2LazerRulesetSetting.ScrollDirection, O2LazerScrollingDirection.Down);
